...
上传并配置好数据库后，通过 https://example.com/admin 访问后台地址（默认账号：admin@qq.com,默认密码：123456），并进行设置

进入后台将支付接口的 商户ID 和 MD5密钥 填写完成，并进行设置机器人 Token、群组ID、群组链接、机器人链接就算是完成了，后续慢慢自己添加套餐
